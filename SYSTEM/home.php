...
<body method="post">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<button class="btn btn-lg btn-info" style="float: left; margin-top: 3%" data-toggle="modal" data-target="#myModal">Add New Production</button> 
				<!--<button class="btn btn-lg btn-info" style="float: right; margin-top: 3%"><a href="dash.php">DashBoard</a></button>-->
			</div>
		</div><!--/.row-->
		<br>
		<!--Modal-->
		...
		<div class="panel panel-container">
			<table class="table table-striped">
				...
				<tr>
    				...
    				<td><!--<a href='editPro.php?id=<?php echo "$id";?>'>Change</a> &nbsp;-->
